...
banner:
  ...
  content: Nous voulons aménager cet espace innocupé du batiment 9, pour l'embellir
    et l'entretenir à sa juste valeur.
  button:
    enable: true
...
about:
  ...
  description: Nous sommes les deux propriétaires juxtaposant ce toit terrasse et
    ayant l'accès exclusif.
